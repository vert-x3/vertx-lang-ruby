...
module Vertx
  ...
  class NetSocketStream
    ...
    def @@j_api_type.accept?(obj)
      obj.class == NetSocketStream
    end
    def @@j_api_type.wrap(obj)
      NetSocketStream.new(obj)
    end
    ...
    def self.j_class
      Java::IoVertxCoreNet::NetSocketStream.java_class
    end
    # @yield 
    # @return [self]
    ...
    def handler
      if block_given?
        @j_del.java_method(:handler, [Java::IoVertxCore::Handler.java_class]).call((Proc.new { |event| yield(::Vertx::Util::Utils.safe_create(event,::Vertx::NetSocket)) }))
        return self
      end
