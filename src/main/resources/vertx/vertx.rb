...
module Vertx
  class Vertx
    ...
    #
    # @param [Hash] options
    # @return [::Vertx::Vertx]: the return value (todo)
    ...
    # THE METHOD DOC
    #
    # @return [::Vertx::Context]: the return value (todo)
    ...
    #
    # @param [Hash] options
    # @return [::Vertx::NetClient]: the return value (todo)
    ...
    #
    # @param [Hash] options
    # @return [::Vertx::DatagramSocket]: the return value (todo)
    ...
    # THE METHOD DOC
    #
    # @return [::Vertx::FileSystem]: the return value (todo)
    def file_system
    ...
    # THE METHOD DOC
    #
    # @return [::Vertx::EventBus]: the return value (todo)
    def event_bus
    ...
    # @param [Fixnum] port
    # @param [String] host
    # @return [::Vertx::DnsClient]: the return value (todo)
    ...
    # THE METHOD DOC
    #
    # @return [::Vertx::SharedData]: the return value (todo)
    def shared_data
    ...
    #
    # @param [Fixnum] delay
    # @return [::Vertx::TimeoutStream]: the return value (todo)
