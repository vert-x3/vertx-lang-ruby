...
Coordination of multiple asynchronous results can be achieved with Vert.x `link:../../yardoc/Vertx/Future.html[futures]`.
...
The handler returned by `link:../../yardoc/Vertx/Future.html#completer-instance_method[completer]` completes the future.

`link:../../yardoc/Vertx/CompositeFuture.html#any-class_method[CompositeFuture.any]` takes several futures arguments (up to 6) and returns a future that is
...
`link:../../yardoc/Vertx/Future.html#compose-instance_method[compose]` can be used for chaining futures:
